...
void main() {
  ...
  Widget wrap({
    String? reportEmail,
    ListingDetailsUriLauncher? launcher,
  }) =>
      MaterialApp(
  ...
  testWidgets(
    'report email unset: Report listing surface is hidden',
    (tester) async {
  ...
  testWidgets(
    'report email empty string: Report listing surface is hidden',
    (tester) async {
  ...
  testWidgets(
    'report email configured: renders the Report listing action with '
    'supporting copy',
    (tester) async {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.pumpWidget(
        wrap(
          reportEmail: 'reports@carzon.example',
          launcher: launcher,
        ),
      );
      await tester.pump();
