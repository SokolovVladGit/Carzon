...
void main() {
  ...
  group('resolveEditListingVinRpcSubmission', () {
    test(
      'A: preload succeeded + field unchanged omits p_vin',
      () {
    ...
    test(
      'B: preload succeeded + field cleared sends empty p_vin',
      () {
        final d = resolveEditListingVinRpcSubmission(
          rawVinFieldText: '',
          ownerVinNormalizedForEdit: validVin,
    ...
    test(
      'C: preload failed + empty field omits p_vin',
      () {
        final d = resolveEditListingVinRpcSubmission(
          rawVinFieldText: '  \n',
    ...
    test(
      'D: preload failed + valid messy VIN sends normalized p_vin',
      () {
        final d = resolveEditListingVinRpcSubmission(
    ...
    test(
      'preload succeeded + no prior VIN + empty field omits p_vin',
      () {
        final d = resolveEditListingVinRpcSubmission(
          rawVinFieldText: '',
          ownerVinNormalizedForEdit: null,
    ...
    test(
      'preload succeeded + no prior VIN + new VIN sends p_vin',
      () {
        final d = resolveEditListingVinRpcSubmission(
          rawVinFieldText: validVin,
          ownerVinNormalizedForEdit: null,
