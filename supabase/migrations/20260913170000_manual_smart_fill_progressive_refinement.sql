-- Carzon — Manual Smart Fill v2: progressive refinement.
--
-- Does not replace public.resolve_vehicle_by_identity (v1 / m1.1).
-- Does not alter catalog tables, listings, or ingest data.
-- Mapping version for this RPC only: m1.2.
...
begin
    ...
    if v_status = 'invalidRefinement' or v_decisions > 3 then
        return public.carzon_open_data_v2_payload(
